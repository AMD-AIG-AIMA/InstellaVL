...
image_folder = 'viquae/images/%s' % split
...
new_json_file = 'viquae_%s_process.json' % split
if not os.path.exists('playground/data/viquae'):
    os.makedirs('playground/data/viquae')
dst_json_file = os.path.join('playground/data/viquae', new_json_file)
print(len(new_data))
